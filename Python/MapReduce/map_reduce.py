# Map Reduce
#
# When data is too large to process on a really good server!
# i.e. over 5 TB
#
# Like parallel programming with out MPI
# 
# Only for tasks that really couldn;t be completed with out
#
# Mapper +reducer
# 
# Mapper assings key values and sends key val pairs to reducer
# 
#############################################################
##                                                         ##
 ### Example of annoyling word count with out mapreduce  ###
##                                                         ##
#############################################################
...
#
# That counts the words serially
#
# Thats fine for 1 book, but if you wanted to do that on all the books ever
# written
#
#
